...
def get_assets_with_album_info(db_file_path: str, restore_original_filename: bool) -> List[AssetWithAlbumInfo]:
    """
    ...
    export_asset_dtos = repo.get_asset_data_with_album_info(db_file_path)
